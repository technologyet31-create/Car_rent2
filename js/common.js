...
(function () {
  ...
  const BASE_CARS = [
    ...
    },
    {
      ...
      fuel: "بنزين",
      seats: 5,
      description: "سيدان واسعة ومناسبة للسفر داخل المدينة وخارجها، عزل ممتاز وراحة عالية.",
    },
    {
      id: "accent-2021",
      name: "Hyundai Accent",
      ...
      category: "Economy",
      pricePerDay: 110,
      img: "img/josh-berquist-_4sWbzH5fp8-unsplash.jpg",
      transmission: "أوتوماتيك",
      fuel: "بنزين",
      seats: 5,
      description: "اقتصادية وخفيفة، مناسبة للمشاوير اليومية مع استهلاك وقود جيد.",
    },
    {
      id: "cx5-2022",
      name: "Mazda CX-5",
      ...
      category: "SUV",
      pricePerDay: 240,
      img: "img/campbell-3ZUsNJhi_Ik-unsplash.jpg",
      transmission: "أوتوماتيك",
      fuel: "بنزين",
      seats: 5,
      description: "SUV أنيقة ومريحة، ثبات ممتاز، مناسبة للعائلة والرحلات.",
    },
    {
      id: "patrol-2022",
      name: "Nissan Patrol",
      ...
      fuel: "بنزين",
      seats: 7,
      description: "SUV كبيرة للرحلات والعائلة، مساحة واسعة وأداء قوي.",
    },
    {
      id: "rio-2020",
      name: "Kia Rio",
      ...
      fuel: "بنزين",
      seats: 5,
      description: "اقتصادية جداً للاستخدام اليومي، سهلة في القيادة والركن.",
    },
    {
      id: "a4-2021",
      name: "Audi A4",
      ...
      category: "Sedan",
      pricePerDay: 280,
      img: "img/view-3d-car.jpg",
      transmission: "أوتوماتيك",
      fuel: "بنزين",
      seats: 5,
      description: "سيدان فاخرة بتجربة قيادة مميزة، مناسبة للاجتماعات والزيارات الرسمية.",
    },
    {
      id: "rav4-2022",
      name: "Toyota RAV4",
      ...
      category: "SUV",
      pricePerDay: 260,
      img: "img/automobile-details-close-up-new-car.jpg",
      transmission: "أوتوماتيك",
      fuel: "بنزين",
      seats: 5,
      description: "SUV عملية بتوازن ممتاز بين الراحة والاقتصادية، مناسبة للعائلة.",
    },
    {
      id: "civic-2023",
      name: "Honda Civic",
      ...
      category: "Sedan",
      pricePerDay: 175,
      img: "img/2f046a63-c992-49c6-b1a7-1892a55d765a.jpg",
      transmission: "أوتوماتيك",
      fuel: "بنزين",
      seats: 5,
      description: "سيدان شبابية، تصميم جميل واستهلاك مناسب للوقود.",
    },
  ];
